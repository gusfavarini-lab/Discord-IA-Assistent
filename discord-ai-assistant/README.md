...
2. Copie `.env.example` para `.env` e preencha com seus valores reais:
...
> Nunca adicione tokens reais em `.env.example`. Use `.env` para armazenar valores locais e mantenha o arquivo no `.gitignore`.
